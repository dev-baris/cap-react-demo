import {IonButton, IonButtons, IonContent, IonHeader, IonInput, IonLabel, IonMenuButton, IonPage, IonSelect, IonSelectOption, IonText, IonTitle, IonToolbar,} from '@ionic/react';
  ...
  return (
    <IonPage>
      ...
      <IonContent style={{fontSize: 'x-large'}}>
        ...
        <IonButton expand="block" onClick={() => sendRequest()}>
          Send Request
        </IonButton>
      </IonContent>
    </IonPage>
