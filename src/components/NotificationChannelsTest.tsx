import {Channel as LocalNotificationChannel, LocalNotifications} from '@capacitor/local-notifications';
import {
  IonButton,
  IonContent,
  IonHeader,
...
type NewChannelForm = Omit<LocalNotificationChannel, 'id'>;

export default function NotificationChannelsTest() {
  const [showModal, setShowModal] = useState<boolean>(false);
  const [channelsList, setChannelsList] = useState<LocalNotificationChannel[]
  >([]);
